                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          Container(
                              height: 10,
                              width: (size.height * 0.3015 / widget.length) *
                                    ...
                                    onTap: () {
                                      ...
                                      setState(() {
                                        if (isCard[index] == true) {
                                          result = screen.optionset1![index];
                                        } else {
                                          result = '';
                                        }
                                      });
                                  ...
                                  setState(() {
                                    ...
                                    if (isCard[index] == true) {
                                      ...
                                      for (var i = 0;
                                          i < _controller.length;
                                          i++) {
                                        if (_controller[i].text == selected) {
                                          _controller[i].text = '';
                                          break;
                                        }
                                      }
                          ...
                          child: Column(
                            children: [
                              TextFormField(
                                ...
                                onChanged: (value) => result = value.trim(),
                              ),
                            ],
                          ),
                        ),
