...
class GlobalRanks extends StatefulWidget {
  const GlobalRanks({super.key});

  @override
  State<GlobalRanks> createState() => _GlobalRanksState();
}

class _GlobalRanksState extends State<GlobalRanks> {
  List<BuddyProfileData> globalusers = listofusers;
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        SizedBox(
          height: size.height - size.height * 0.249 - size.height * 0.203,
          width: size.width,
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              var length = (globalusers.length >= 1000);
              return (index + 1) == indexrank
                  ? const SizedBox()
                  : Container(
