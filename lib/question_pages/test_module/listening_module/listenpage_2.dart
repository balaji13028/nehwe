...
class TestListening2 extends StatefulWidget {
  ...
  @override
  State<TestListening2> createState() => _TestListening2State();
}

class _TestListening2State extends State<TestListening2> {
    ...
    return Scaffold(
      ...
      child: Stack(children: [
        Column(
          ...
          children: [
            testScreenTopbar(context, user.lifes, widget.index, widget.length),
            Container(
                          ...
                          decoration: const InputDecoration(
                            enabledBorder: UnderlineInputBorder(
                              borderSide: BorderSide(
                                  color: ColorPalette.textcolor, width: 1.5),
                            ),
