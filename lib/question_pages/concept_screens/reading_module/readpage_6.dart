...
class ReadingModule6 extends StatefulWidget {
  ScreenData screendata;
  int index;
  ReadingModule6({Key? key, required this.screendata, required this.index})
      : super(key: key);

  @override
  State<ReadingModule6> createState() => _ReadingModule6State();
}

class _ReadingModule6State extends State<ReadingModule6> {
