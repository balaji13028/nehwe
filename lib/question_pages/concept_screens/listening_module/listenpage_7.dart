...
class ListeningModule7 extends StatefulWidget {
  ScreenData screendata;
  int index;
  ListeningModule7({Key? key, required this.index, required this.screendata})
      : super(key: key);

  @override
  State<ListeningModule7> createState() => _ListeningModule7State();
}

class _ListeningModule7State extends State<ListeningModule7> {
