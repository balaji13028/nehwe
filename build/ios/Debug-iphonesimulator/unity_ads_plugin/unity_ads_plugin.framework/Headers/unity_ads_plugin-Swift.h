...
#ifndef UNITY_ADS_PLUGIN_SWIFT_H
#define UNITY_ADS_PLUGIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="unity_ads_plugin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16unity_ads_plugin19SwiftUnityAdsPlugin")
@interface SwiftUnityAdsPlugin : NSObject <FlutterPlugin>
...
SWIFT_CLASS("_TtC16unity_ads_plugin30UnityAdsInitializationListener")
...
SWIFT_CLASS("_TtC16unity_ads_plugin20UnityAdsLoadListener")
...
SWIFT_CLASS("_TtC16unity_ads_plugin20UnityAdsShowListener")
